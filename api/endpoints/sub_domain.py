...
@router.post('/', response_model=SubDomainRead, dependencies=[Depends(admin_access)])
...
@router.get('/', response_model=PaginatedResponse[SubDomainRead], dependencies=[Depends(admin_access)])
