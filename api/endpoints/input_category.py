...
@router.get('/', response_model=PaginatedResponse[InputCategoryList], dependencies=[Depends(admin_access)])
...
@router.get('/{uuid}', response_model=InputCategoryRead, dependencies=[Depends(admin_access)])
