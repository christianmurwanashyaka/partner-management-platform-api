...
class Party(CommonBaseModel, table=True):
    ...
    organization: Optional['Organization'] = Relationship(back_populates='parties', sa_relationship_kwargs={'lazy': 'noload'})
    ...
    mou_detail: Optional['MouDetail'] = Relationship(back_populates='parties', sa_relationship_kwargs={'lazy': 'noload'})
