...
class Input(CommonBaseModel, table=True):
    ...
    category: 'InputCategory' = Relationship(back_populates='inputs', sa_relationship_kwargs={'lazy': 'noload'})
    ...
    input_details: List['InputDetail'] = Relationship(back_populates='input', sa_relationship_kwargs={'lazy': 'noload'})
...
class InputCategory(CommonBaseModel, table=True):
    ...
    inputs: List[Input] = Relationship(back_populates='category', sa_relationship_kwargs={'lazy': 'noload'})
    input_details: List['InputDetail'] = Relationship(back_populates='input_category', sa_relationship_kwargs={'lazy': 'noload'})
