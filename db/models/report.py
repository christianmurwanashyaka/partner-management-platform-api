...
class Report(CommonBaseModel, table=True):
    ...
    comments: List['Comment'] = Relationship(back_populates='report', sa_relationship_kwargs={'lazy': 'selectin'})
    ...
    reported_activities: List['ReportActivity'] = Relationship(back_populates='report', sa_relationship_kwargs={'lazy': 'selectin'})
