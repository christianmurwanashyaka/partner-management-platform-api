...
class SubFunction(CommonBaseModel, table=True):
    ...
    function: 'SubDomainFunction' = Relationship(back_populates="sub_functions", sa_relationship_kwargs={'lazy': 'noload'})
    activities: List['ActivityDomain'] = Relationship(back_populates='sub_function', sa_relationship_kwargs={'lazy': 'noload'})
...
class SubDomainFunction(CommonBaseModel, table=True):
    ...
    sub_domain: 'SubDomain' = Relationship(back_populates='functions', sa_relationship_kwargs={'lazy': 'noload'})
    sub_functions: List[SubFunction] = Relationship(back_populates='function', sa_relationship_kwargs={'lazy': 'noload'})
    activities: List['ActivityDomain'] = Relationship(back_populates='sub_domain_function', sa_relationship_kwargs={'lazy': 'noload'})
...
class SubDomain(CommonBaseModel, table=True):
    ...
    domain: 'DomainIntervention' = Relationship(back_populates='subdomains', sa_relationship_kwargs={'lazy': 'noload'})
    functions: List[SubDomainFunction] = Relationship(back_populates='sub_domain', sa_relationship_kwargs={'lazy': 'noload'})
    activities: List['ActivityDomain'] = Relationship(back_populates='sub_domain', sa_relationship_kwargs={'lazy': 'noload'})
...
class DomainIntervention(CommonBaseModel, table=True):
    ...
    subdomains: List[SubDomain] = Relationship(back_populates='domain', sa_relationship_kwargs={'lazy': 'noload'})
    activities: List['ActivityDomain'] = Relationship(back_populates='domain_intervention', sa_relationship_kwargs={'lazy': 'noload'})
    users: List['UserDomain'] = Relationship(back_populates='domain_intervention', sa_relationship_kwargs={'lazy': 'noload'})
